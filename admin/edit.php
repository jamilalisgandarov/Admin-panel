			...
			<div class="col-md-12">
				<form action="" method="post" role="form">
					...
					<div class="form-group">
						...
						<input type="text" name="short_desc" id="short_desc" class="form-control" value=<?php echo $array['short_desc'] ?>>
					</div>
					<div class="form-group">
						<label for="full_desc"> Full description</label>
						<textarea type="text" name="full_desc" id="full_desc" class="form-control" ><?php echo $array['full_desc'] ?>
						</textarea>
					</div>
					<div class="form-group">
						<label for="category"> Category</label>
						<input type="text" name="category" id="category" class="form-control" value=<?php echo $array['category'] ?>>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="checkbox" name="published" id="published" <?= $array['published']==true ? 'checked':''  ?>>
					</div>
					<div class="form-group">
						<input type="submit" name="submit" class="btn-primary btn" value="Update">
					</div>
				</form>
			</div>		
		</div><!--/.row-->
